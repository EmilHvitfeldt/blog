...
knitr::include_graphics("netlify-teams.png")
```

Select Github for Continuous Deployment

```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("create-new-site.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("pick-a-repository.png")
```

Don't touch any of the settings.

```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("deploy-settings.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("new-site.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("site-id.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("user-settings.png")
```

And click on "New access token" to create a personal access token

```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("personal-access-token.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("generate-token.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("created-token.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("github-settings.png")
```

go to "Secrets"

```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("github-secrets.png")
```

Click on "Add a new secret"

```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("add-new-secret.png")
```
...
```{r echo=FALSE, fig.align='center'}
knitr::include_graphics("fill-in-secret.png")
```
