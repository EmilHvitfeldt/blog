...
knitr::include_graphics("/img/blog/recreate-sunshine-report/2018-01-01-13.53scan.jpg")
```
...
```{r include=FALSE}
load(glue("~/Github/blog/static/img/blog/recreate-sunshine-report/{airport_code}-{year}.Rdata"))
```
...
load(glue("~/Github/blog/static/img/blog/recreate-sunshine-report/KNYC-{year}.Rdata"))
full_data2 %>%
  mutate(con = Conditions == "Clear",
         day_minutes2 = lag(day_minutes)) %>%
  filter(sun_up) %>%
