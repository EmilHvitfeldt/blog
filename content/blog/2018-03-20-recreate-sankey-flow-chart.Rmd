...
*This code have been revised to make sure it works as of 2018-12-19. An updated version of this blogpost have been created since the new release of gganimate broke the code in the original post. Both versions of the post is available here.*  
...
knitr::include_graphics("/img/blog/recreate-sankey-flow-chart/nytimes.png")
```
...
![](/img/blog/recreate-sankey-flow-chart/01-old.png)
...
![](/img/blog/recreate-sankey-flow-chart/02-old.gif)
...
![](/img/blog/recreate-sankey-flow-chart/03-old.gif)
...
![](/img/blog/recreate-sankey-flow-chart/04-old.gif)
...
![](/img/blog/recreate-sankey-flow-chart/05-old.gif)
...
![](/img/blog/recreate-sankey-flow-chart/06-old.gif)
...
![](/img/blog/recreate-sankey-flow-chart/07-old.gif)
