...
```{r include=FALSE}
img <- image("~/Github/blog/static/img/blog/rvision-a-first-look/parrot.jpg")
```
...
```{r include=FALSE}
img <- image("~/Github/blog/static/img/blog/rvision-a-first-look/balls.jpg")
plot(img)
```
...
```{r include=FALSE}
my_img <- image("~/Github/blog/static/img/blog/rvision-a-first-look/file45425287b9e9.png")
```
...
![](/img/blog/rvision-a-first-look/Feb-15-2018 11-12-04.gif)
